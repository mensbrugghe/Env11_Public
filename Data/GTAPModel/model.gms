...
*  Technical variables
   ...
   lambdaw(s,i,d,t)     "Change in second-level Armington preferences"
...
Parameters
   ...
   lambdad(r,i,aa,t)    "Armington domestic 'twist' parameter"
   lambdam(r,i,aa,t)    "Armington import 'twist' parameter"
   twistd(r,i,aa,t)     "Adjusted Armington domestic 'twist' parameter"
   twistm(r,i,aa,t)     "Adjusted Armington import 'twist' parameter"
...
*  01-May-2019: National top level Armington nest
   ...
   twistw(s,i,r,t)      "Adjusted second level twist parameter"
...
*  Public demand
   ...
   xageq(r,i,fd,t)      "Public expenditure on Armington goods and services"
   pgeq(r,t)            "Public expenditure price deflator"
   xgeq(r,t)            "Real government expenditure"

*  Investment demand

   xaieq(r,i,fd,t)      "Investment expenditure on Armington goods and services"
...
*  TT services
   ...
   xatmgeq(r,m,fd,t)    "Regional supply of TT services by mode"
...
Parameter
   pcarb0(r)            "User-defined carbon price for process emissions"
;
...
pxeq(r,a,t)$(rs(r) and ts(t) and xpFlag(r,a))..
   px(r,a,t) =e= (1/axp(r,a,t))
      *  (ava(r,a,t)*(pva(r,a,t)/lambdava(r,a,t))**(1-sigmap(r,a))
      +   and(r,a,t)*(pnd(r,a,t)/lambdand(r,a,t))**(1-sigmap(r,a)))**(1/(1-sigmap(r,a))) ;
...
pvaeq(r,a,t)$(rs(r) and ts(t) and vaFlag(r,a))..
   pva(r,a,t) =e= sum(fp, af(r,fp,a,t)
               *     (M_PFA(r,fp,a,t)/lambdaf(r,fp,a,t))**(1-sigmav(r,a)))**(1/(1-sigmav(r,a))) ;
...
*  Finite elasticity
   0 =e= (x(r,a,i,t) - xp(r,a,t) * (p(r,a,i,t)/((1 + ctax(r,a,t))*px(r,a,t)))**omegas(r,a))
      $(omegas(r,a) ne inf)

*  Perfect transformation
      +  (p(r,a,i,t) - (1 + ctax(r,a,t))*px(r,a,t))
      $(omegas(r,a) eq inf)
      ;
...
*  'Output' tax --
      ...
      + (sum(a, ctax(r,a,t)*px(r,a,t)*xp(r,a,t)*px0(r,a)*xp0(r,a)))$sameas(gy,"ct")
      ;
...
ctaxeq(r,a,t)$(rs(r) and ts(t) and ctaxFlag(r,a) and sum(em, procEmi0(r,em,a)))..
   ctax(r,a,t)*px(r,a,t)*xp(r,a,t)*px0(r,a)*xp0(r,a) =e=
      sum(em, pcarb0(r)*(inscale/cscale)*procEmi0(r,em,a)) ;
...
* 15-Aug-2025 Add Armington 'twist'

paeq(r,i,aa,t)$(rs(r) and ts(t) and xaFlag(r,i,aa) ne 0)..
   pa(r,i,aa,t)
      =e= ((twistd(r,i,aa,t)*alphad(r,i,aa,t)*(M_PDP(r,i,aa,t)/lambdad(r,i,aa,t))**(1-sigmam(r,i,aa))
       +    twistm(r,i,aa,t)*alpham(r,i,aa,t)*(M_PMP(r,i,aa,t)/lambdam(r,i,aa,t))**(1-sigmam(r,i,aa)))**(1/(1-sigmam(r,i,aa))))
       $(not ArmFlag(r,i))
...
xdeq(r,i,aa,t)$(rs(r) and ts(t) and alphad(r,i,aa,t) ne 0 and not ArmFlag(r,i))..
   xd(r,i,aa,t) =e= twistd(r,i,aa,t)*xa(r,i,aa,t) * (lambdad(r,i,aa,t)**(sigmam(r,i,aa)-1))
...
xmeq(r,i,aa,t)$(rs(r) and ts(t) and alpham(r,i,aa,t) ne 0 and not ArmFlag(r,i))..
   xm(r,i,aa,t) =e= twistm(r,i,aa,t)*xa(r,i,aa,t) * (lambdam(r,i,aa,t)**(sigmam(r,i,aa)-1))
...
xweq(s,i,r,t)$(rs(r) and ts(t) and xwFlag(s,i,r))..
   xw(s,i,r,t) =e= (twistw(s,i,r,t)*xmt(r,i,t)*((pmt(r,i,t)/(M_PM(s,i,r,t)))**sigmaw(r,i))
                *   lambdaw(s,i,r,t)**(sigmaw(r,i) - 1))$(not MRIO)
...
pmteq(r,i,t)$(rs(r) and ts(t) and xmtFlag(r,i) and not MRIO)..
   pmt(r,i,t)**(1-sigmaw(r,i)) =e=
      sum(s$xwFlag(s,i,r), twistw(s,i,r,t)*amw(s,i,r,t)*(M_PM(s,i,r,t)/lambdaw(s,i,r,t))**(1-sigmaw(r,i))) ;
...
xfteq(r,fm,t)$(rs(r) and ts(t) and xftFlag(r,fm))..
   0 =e= (xft(r,fm,t)- (aft(r,fm,t)*((pft0(r,fm)/pabs0(r))**etaf(r,fm))/xft0(r,fm))
                *    (pft(r,fm,t)/pabs(r,t))**etaf(r,fm))$l(fm)
      +  (xft(r,fm,t)- (aft(r,fm,t)*((pft0(r,fm)/pabs0(r))**etaf(r,fm))/xft0(r,fm))
                *    (pft(r,fm,t)/pabs(r,t))**etaf(r,fm))$((cap(fm) and not ifDyn) or lnd(fm))
      +  (krat(r,t)*kstock(r,t) - sum(cap, (xft0(r,cap)/kstock0(r))*xft(r,cap,t)))$(cap(fm) and ifDyn)
      ;
...
kstockeq(r,t)$(rs(r) and ts(t))..
   0 =e= (krat(r,t)*kstock(r,t) - sum(cap, (xft0(r,cap)/kstock0(r))*xft(r,cap,t)))$(ifDyn eq 0)
      +  (kstock(r,t) - kapEnd(r,t-1))$(ifDyn eq 1)
      ;
...
uedeq(r,i,j,h,t)$(rs(r) and ts(t) and xaFlag(r,i,h) ne 0 and xaFlag(r,j,h) and (%utility% eq CDE))..
   ued(r,i,j,t)
      =e= xcshr0(r,i,h)*xcshr(r,i,h,t)*(-bh(r,i,t)
       ...
       /  sum(jp, xcshr0(r,jp,h)*xcshr(r,jp,h,t)*eh(r,jp,t))) + (bh(r,i,t) - 1)$sameas(i,j) ;
...
apeeq(r,i,j,h,t)$(rs(r) and ts(t) and xaFlag(r,i,h) ne 0 and xaFlag(r,j,h) and (%utility% eq CDE))..
   ape(r,i,j,t) =e= 1 - bh(r,j,t) - bh(r,i,t) + sum(jp, xcshr0(r,jp,h)*xcshr(r,jp,h,t)*bh(r,jp,t))
                 -  ((1-bh(r,i,t))$sameas(i,j))/(xcshr0(r,j,h)*xcshr(r,j,h,t)) ;
...
model core /
   ...
   xageq.xa, pgeq.pg, xaieq.xa, pieq.pi, yieq.yi,
...
*  xfteq.xft, pfeq.pf, pfteq.pft, pfaeq.pfa, pfyeq.pfy, kstockeq.kstock,
   ...
   kapEndeq.kapEnd, rorceq.rorc, roreeq.rore, xieq.xi,
...
model gtap /
   core + rgdpmpeq.rgdpmp + xgeq.xg + arenteq.arent
/ ;
...
Equation
   betass(r,t)    "Steady-state equation for betas parameter"
;

singleton set tss(t) ;

betass(r,t)$(years(t) ge years(tss) and ifSteadyState)..
   betas(r,t) =e= betas(r,t-1) ;

model dynCal /
   core + rgdpmpeq.afereg + xgeq.betag + arenteq + betass
/ ;
dyncal.holdfixed = 1 ;
dyncal.scaleopt  = 1 ;
