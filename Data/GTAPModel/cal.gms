...
xd.l(r,i,a,t) = inScale*vdfb(i,a,r)/pd.l(r,i,t) ;
xm.l(r,i,a,t) = inScale*vmfb(i,a,r)/pmt.l(r,i,t) ;

dintx.fx(r,i,a,t)$xd.l(r,i,a,t)
   = inScale*(vdfp(i,a,r) - vdfb(i,a,r)) / (pd.l(r,i,t)*xd.l(r,i,a,t)) ;
mintx.fx(r,i,a,t)$xm.l(r,i,a,t)
   = inScale*(vmfp(i,a,r) - vmfb(i,a,r)) / (pmt.l(r,i,t)*xm.l(r,i,a,t)) ;

*  Private demand

xd.l(r,i,h,t) = inScale*vdpb(i,r)/pd.l(r,i,t) ;
xm.l(r,i,h,t) = inScale*vmpb(i,r)/pmt.l(r,i,t) ;

dintx.fx(r,i,h,t)$xd.l(r,i,h,t)
   = inScale*(vdpp(i,r) - vdpb(i,r)) / (pd.l(r,i,t)*xd.l(r,i,h,t)) ;
mintx.fx(r,i,h,t)$xm.l(r,i,h,t)
   = inScale*(vmpp(i,r) - vmpb(i,r)) / (pmt.l(r,i,t)*xm.l(r,i,h,t)) ;

*  Government demand

xd.l(r,i,gov,t) = inScale*vdgb(i,r) / pd.l(r,i,t) ;
xm.l(r,i,gov,t) = inScale*vmgb(i,r) / pmt.l(r,i,t) ;

dintx.fx(r,i,gov,t)$xd.l(r,i,gov,t)
   = inScale*(vdgp(i,r) - vdgb(i,r)) / (pd.l(r,i,t)*xd.l(r,i,gov,t)) ;
mintx.fx(r,i,gov,t)$xm.l(r,i,gov,t)
   = inScale*(vmgp(i,r) - vmgb(i,r)) / (pmt.l(r,i,t)*xm.l(r,i,gov,t)) ;

*  Investment demand

xd.l(r,i,inv,t) = inScale*vdib(i,r) / pd.l(r,i,t) ;
xm.l(r,i,inv,t) = inScale*vmib(i,r) / pmt.l(r,i,t) ;

dintx.fx(r,i,inv,t)$xd.l(r,i,inv,t)
   = inScale*(vdip(i,r) - vdib(i,r)) / (pd.l(r,i,t)*xd.l(r,i,inv,t)) ;
mintx.fx(r,i,inv,t)$xm.l(r,i,inv,t)
   = inScale*(vmip(i,r) - vmib(i,r)) / (pmt.l(r,i,t)*xm.l(r,i,inv,t)) ;

*  Domestic supply of margin services

xd.l(r,i,tmg,t) = inScale*vst(i,r)/pd.l(r,i,t) ;
xm.l(r,i,tmg,t) = 0 ;
...
if(1,
   ...
   kappaf.l(r,fp,a,t) = inscale*EVFB(fp,a,r) ;
   kappaf.fx(r,fp,a,t)$kappaf.l(r,fp,a,t)
                      = inscale*(EVFB(fp,a,r) - EVOS(fp,a,r))
                      /    kappaf.l(r,fp,a,t) ;
   pf.l(r,fp,a,t)     = pfy.l(r,fp,a,t)/(1 - kappaf.l(r,fp,a,t)) ;
   xf.l(r,fp,a,t)     = inScale*evfb(fp,a,r) / pf.l(r,fp,a,t) ;
...
fctts.fx(r,fp,a,t)$xf.l(r,fp,a,t)
   = -inScale*fbep(fp,a,r)/(pf.l(r,fp,a,t)*xf.l(r,fp,a,t)) ;
fcttx.fx(r,fp,a,t)$xf.l(r,fp,a,t)
   =  inScale*ftrv(fp,a,r)/(pf.l(r,fp,a,t)*xf.l(r,fp,a,t)) ;
...
x.l(r,a,i,t) = inScale*makb(i,a,r) ;
loop(t0,
   xFlag(r,a,i)$x.l(r,a,i,t0) = 1 ;
) ;

prdtx.l(r,a,i,t) = inScale*maks(i,a,r) ;
...
$macro M_VIUMS(i,amrio,s,d)    (inscale*viums(i, amrio, s ,d))
$macro M_VIUWS(i,amrio,s,d)    (inscale*viuws(i, amrio, s ,d))

if(MRIO,
   imptxa.l(s,i,d,a,t) = M_VIUWS(i,"INT",s,d) ;
   imptxa.l(s,i,d,a,t)$imptxa.l(s,i,d,a,t) = M_VIUMS(i,"INT",s,d)/imptxa.l(s,i,d,a,t) - 1.0 ;
   loop(gov,
      imptxa.l(s,i,d,gov,t) = VIUWS(i,"CONS",s,d) ;
...
loop(tmg,
   ...
   xmgm.l(m,r,i,d,t)
      = inScale*VTWR(m,i,r,d) / ptmg.l(m,t) ;
...
emid.l(r,i,a,t) = mdf(i, a, r) ;
emim.l(r,i,a,t) = mmf(i, a, r) ;

*  Household emissions

emid.l(r,i,h,t) = mdp(i, r) ;
emim.l(r,i,h,t) = mmp(i, r) ;

*  Government emissions

emid.l(r,i,gov,t) = mdg(i, r) ;
emim.l(r,i,gov,t) = mmg(i, r) ;

*  Investment emissions

emid.l(r,i,inv,t) = mdi(i, r) ;
emim.l(r,i,inv,t) = mmi(i, r) ;
...
*  use import weights
   ...
   sigmawa(r,i,aa)$(sigmawa(r,i,aa) eq na) = sigmaw(r,i) ;
...
loop(h,
   ued.l(r,i,j,t)   = xcshr.l(r,i,h,t)*(-bh.l(r,i,t)
                    ...
                    /  sum(jp, xcshr.l(r,jp,h,t)*eh.l(r,jp,t))) + (bh.l(r,i,t) - 1)$sameas(i,j) ;
   ...
   ape.l(r,i,j,t)$xcshr.l(r,j,h,t)
                    ...
                    -  ((1-bh.l(r,i,t))$sameas(i,j))/xcshr.l(r,j,h,t) ;
) ;
...
if(0 and MRIO,
   ...
   loop((r,i,t)$t0(t),
      loop(a,
         put "VDB", r.tl, i.tl, "", a.tl, vdfb(i,a,r) / ;
         put "VDP", r.tl, i.tl, "", a.tl, vdfp(i,a,r) / ;
         put "VMB", r.tl, i.tl, "", a.tl, vmfb(i,a,r) / ;
         put "VMP", r.tl, i.tl, "", a.tl, vmfp(i,a,r) / ;
      ) ;
      loop(h,
         put "VDB", r.tl, i.tl, "", h.tl, vdpb(i,r) / ;
         put "VDP", r.tl, i.tl, "", h.tl, vdpp(i,r) / ;
         put "VMB", r.tl, i.tl, "", h.tl, vmpb(i,r) / ;
         put "VMP", r.tl, i.tl, "", h.tl, vmpp(i,r) / ;
      ) ;
      loop(gov,
         put "VDB", r.tl, i.tl, "", gov.tl, vdgb(i,r) / ;
         put "VDP", r.tl, i.tl, "", gov.tl, vdgp(i,r) / ;
         put "VMB", r.tl, i.tl, "", gov.tl, vmgb(i,r) / ;
         put "VMP", r.tl, i.tl, "", gov.tl, vmgp(i,r) / ;
      ) ;
      loop(inv,
         put "VDB", r.tl, i.tl, "", inv.tl, vdib(i,r) / ;
         put "VDP", r.tl, i.tl, "", inv.tl, vdip(i,r) / ;
         put "VMB", r.tl, i.tl, "", inv.tl, vmib(i,r) / ;
         put "VMP", r.tl, i.tl, "", inv.tl, vmip(i,r) / ;
      ) ;
   ) ;
   ...
   if(MRIO,
      ...
      loop((i,amrio,s,d),
         put "VIUMS", s.tl, i.tl, d.tl, amrio.tl, (VIUMS(i,amrio,s,d)) / ;
         put "VIUWS", s.tl, i.tl, d.tl, amrio.tl, (VIUWS(i,amrio,s,d)) / ;
      ) ;
   ) ;
   Abort "Temp" ;
)
